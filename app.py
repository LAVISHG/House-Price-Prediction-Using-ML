...
def predict():
    try:
        ...
        print("Loading mean and std values...")
        ...
        all_categorical_columns = ['city_algona', 'city_auburn', 'city_beaux arts village',
           ...
           'city_inglewoodfinn hill', 'city_issaquah', 'city_kenmore', 'city_kent', 
           ...
           'city_redmond', 'city_renton', 'city_sammamish', 'city_seatac', 'city_seattle', 
